...
function compareTrue(B1 , B2) {
  ...
  function fizzBuzz(arraynum) {
      ...
      for (i in arraynum){
        ...
        } else if (arraynum[i]%3 != 0 && arraynum[i]%2 != 0 && arraynum[i]%5 === 0){
  ...
  function encode(vogaismin) {
      vogaismin = vogaismin.replace(/a/g,'1').replace(/e/g , '2').replace(/i/g , '3').replace(/o/g , '4').replace(/u/g , '5');
      return vogaismin;
    // seu código aqui
  }
  function decode(vogaisnum) {
    vogaisnum = vogaisnum.replace(/1/g,'a').replace(/2/g , 'e').replace(/3/g , 'i').replace(/4/g , 'o').replace(/5/g , 'u');
    return vogaisnum;
    // seu código aqui
  }
